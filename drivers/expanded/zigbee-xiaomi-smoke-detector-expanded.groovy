...
metadata {
	definition (name: "Zigbee - Xiaomi Smoke Detector", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-xiaomi-smoke-detector", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-xiaomi-smoke-detector-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Xiaomi Smoke Detector', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-xiaomi-smoke-detector', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-xiaomi-smoke-detector-expanded.groovy']
