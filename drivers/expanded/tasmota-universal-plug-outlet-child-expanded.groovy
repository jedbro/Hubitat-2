...
metadata {
    definition (name: "Tasmota - Universal Plug/Outlet (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-plug-outlet-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-plug-outlet-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Outlet"
        capability "Refresh"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Plug/Outlet (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-plug-outlet-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-plug-outlet-child-expanded.groovy']
