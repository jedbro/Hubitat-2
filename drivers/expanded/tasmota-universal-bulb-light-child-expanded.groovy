...
metadata {
    definition (name: "Tasmota - Universal Bulb/Light (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-bulb-light-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-bulb-light-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Light"
        capability "Refresh"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Bulb/Light (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-bulb-light-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-bulb-light-child-expanded.groovy']
