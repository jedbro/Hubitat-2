...
metadata {
	definition (name: "Zigbee - Sonoff Contact Sensor", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-sonoff-contact-sensor", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-sonoff-contact-sensor-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Sonoff Contact Sensor', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-sonoff-contact-sensor', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-sonoff-contact-sensor-expanded.groovy']
