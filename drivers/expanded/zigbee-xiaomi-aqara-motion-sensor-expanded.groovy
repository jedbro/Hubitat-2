...
metadata {
	definition (name: "Zigbee - Xiaomi/Aqara Motion Sensor", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-xiaomi-aqara-motion-sensor", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-xiaomi-aqara-motion-sensor-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Xiaomi/Aqara Motion Sensor', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-xiaomi-aqara-motion-sensor', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-xiaomi-aqara-motion-sensor-expanded.groovy']
...
ArrayList<String> parse(String description) {
    ...
    if(hasCorrectCheckinEvents(maximumMinutesBetweenEvents=90) == false) {
        ...
        if(getDeviceDataByName('model') != "lumi.sensor_motion") {
            restoreCmd += ["zdo bind ${device.deviceNetworkId} 0x01 0x01 0x0400 {${device.zigbeeId}} {}", "delay 70",]
        }
