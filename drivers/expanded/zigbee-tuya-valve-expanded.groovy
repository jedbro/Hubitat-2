...
metadata {
	definition (name: "Zigbee - Tuya Valve", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-tuya-valve", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-tuya-valve-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Tuya Valve', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-tuya-valve', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-tuya-valve-expanded.groovy']
...
void configureDevice() {
    ...
    cmd += ["zdo bind 0x${device.deviceNetworkId} ${endpointId} 0x01 0x0702 {${device.zigbeeId}} {}", "delay 200"]
    sendZigbeeCommands(cmd)
}
