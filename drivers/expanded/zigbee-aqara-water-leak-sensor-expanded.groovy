...
metadata {
	definition (name: "Zigbee - Aqara Water Leak Sensor", namespace: "oh-lalabs.com", author: "Markus Liljergren", filename: "zigbee-aqara-water-leak-sensor", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-aqara-water-leak-sensor-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Zigbee - Aqara Water Leak Sensor', 'namespace': 'oh-lalabs.com', 'author': 'Markus Liljergren', 'filename': 'zigbee-aqara-water-leak-sensor', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/zigbee-aqara-water-leak-sensor-expanded.groovy']
