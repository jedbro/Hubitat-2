...
metadata {
    definition (name: "Tasmota - Universal Metering Plug/Outlet (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-metering-plug-outlet-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-metering-plug-outlet-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Outlet"
        capability "Sensor"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Metering Plug/Outlet (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-metering-plug-outlet-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-metering-plug-outlet-child-expanded.groovy']
