...
metadata {
    definition (name: "Tasmota - Universal CT/RGB/RGB+CW+WW (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-ct-rgb-cw-ww-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-ct-rgb-cw-ww-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Light"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal CT/RGB/RGB+CW+WW (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-ct-rgb-cw-ww-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-ct-rgb-cw-ww-child-expanded.groovy']
