...
metadata {
    definition (name: "Tasmota - Universal Switch as Garage Door (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-switch-as-garage-door-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-switch-as-garage-door-child-expanded.groovy") {
        capability "Sensor"
        capability "Actuator"
        capability "Switch"
    ...
    preferences {
        ...
        input(name: "reportOpeningClosing", type: "bool", title: styling_addTitleDiv("Extra door status"), description: styling_addDescriptionDiv("Report \"opening\" and \"closing\" status for the door attribute. Default = False"), defaultValue: false)
    }
