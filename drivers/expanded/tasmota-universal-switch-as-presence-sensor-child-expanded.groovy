...
metadata {
    definition (name: "Tasmota - Universal Switch as Presence Sensor (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-switch-as-presence-sensor-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-switch-as-presence-sensor-child-expanded.groovy") {
        capability "Sensor"
