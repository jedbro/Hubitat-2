...
metadata {
    definition (name: "Tasmota - Universal Dimmer (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-dimmer-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-dimmer-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Light"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Dimmer (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-dimmer-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-dimmer-child-expanded.groovy']
