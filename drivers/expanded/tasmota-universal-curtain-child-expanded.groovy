...
metadata {
    definition (name: "Tasmota - Universal Curtain (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-curtain-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-curtain-child-expanded.groovy") {
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Curtain (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-curtain-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-curtain-child-expanded.groovy']
