...
metadata {
    definition (name: "Tasmota - Universal Metering Dimmer (Child)", namespace: "tasmota", author: "Markus Liljergren", filename: "tasmota-universal-metering-dimmer-child", importUrl: "https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-metering-dimmer-child-expanded.groovy") {
        capability "Actuator"
        capability "Switch"
        capability "Light"
...
String getDeviceInfoByName(infoName) { 
    ...
    Map deviceInfo = ['name': 'Tasmota - Universal Metering Dimmer (Child)', 'namespace': 'tasmota', 'author': 'Markus Liljergren', 'filename': 'tasmota-universal-metering-dimmer-child', 'importUrl': 'https://raw.githubusercontent.com/markus-li/Hubitat/development/drivers/expanded/tasmota-universal-metering-dimmer-child-expanded.groovy']
